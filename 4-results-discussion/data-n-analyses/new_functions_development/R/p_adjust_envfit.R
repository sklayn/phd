p_adjust_envfit <- function (x, method = 'bonferroni', n, verbose = FALSE) {
  ...
  ## Arguments: x - envfit object
  ##            method - method for correction of multiple testing issue 
  ##             (default = 'bonferroni', see ''?p.adjust' for more options)
  ##            n - optional, number of tests for which to correct; if not given,
  ##             the number is taken as the number of tests conducted by envfit 
  ##             function (for both vectors and factors).
  ## Author: David Zeleny 
  ## (http://www.davidzeleny.net)
  ...
  if(verbose) cat('Adjustment of significance by', method, 'method')
