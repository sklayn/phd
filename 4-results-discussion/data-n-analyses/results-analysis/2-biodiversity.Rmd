...
## construct the 95% confidence funnels (actually probably 95% tolerance intervals, but who's counting)
...
library(parallel)
core.clust <- makeCluster(detectCores() - 2, type = "FORK") # make core cluster (leaving some cores for the ohter processes, too), making sure to fork the environment, otherwise the functions won't be able to find objects in the global environment
