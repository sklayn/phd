...
envir.params <- as_tibble(read.csv(file.path(data.dir, "water_column_LT_all.csv"), header = TRUE, stringsAsFactors = FALSE, na.strings = ""))

# quick sanity check (variable types, import errors, etc.)
envir.params
```
...
To have more data for my stations, I'll add the data from some other nearby stations in Burgas Bay (and Sozopol Bay): Atia -> Akin; Maslen nos -> Paraskeva.
```{r data_cleaning_1}
