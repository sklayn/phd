...
envir.params <- as_tibble(read.csv(file.path(data.dir, "water column-LT_all.csv"), header = TRUE, stringsAsFactors = FALSE))
...
```{r data_aggregation}
## IS THIS THE CORRECT WAY? - summary by station, year and month (-> over the different depths)
envir.params %>%
