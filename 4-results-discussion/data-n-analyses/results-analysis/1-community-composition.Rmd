...
(plot.composite.tax.gr.props.sand <- plot_tax_props(tax.props.sand.all, x.labels = "S") + 
  ...
  text_size(text.x = rel(1.3), text.y = rel(1.3), title.x = rel(1.3), legend.text = rel(1.2), strip.x = rel(1.3), strip.y = rel(1.3))
)

ggsave(file.path(figures.dir, "tax_gr_props_sand_composite.png"),
...
ggsave(file.path(figures.dir, "tax_gr_props_zostera_composite.png"),
...
ggsave(file.path(figures.dir, "tax_gr_props_2012_composite.png"),
