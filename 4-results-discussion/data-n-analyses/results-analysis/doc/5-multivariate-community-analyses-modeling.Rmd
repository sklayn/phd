...
sp.response.glms.env.sand <- traitglm(L = zoo.mvabnd.sand, 
                                      R = env.sand %>% select(NH4, NO3, PO4, seston, secchi, TOM, gravel), 
                                      formula = ~ NH4 + NO3 + PO4 + seston + secchi + TOM + gravel, 
                                      method = "manyglm")


sp.response.glms.env.sand
```
