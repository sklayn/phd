...
The algorithm fails to converge - I'm not sure how to interpret it.. Maybe because the function tries to fit univariate models to each species (does it really??), and none of the explanatory environmental variables by themselves are sufficient to explain a species' response. In fact, everything points towards the conclusion that a species response is determined by a combination of eutrophication parameters in its environment (water column characteristics), and the composition of the sediments (organic matter and granulometry).  
