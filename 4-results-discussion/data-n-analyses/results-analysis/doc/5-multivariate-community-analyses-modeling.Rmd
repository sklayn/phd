...
If quantitative variables are included in the model -> if there is a trend in size of residuals at different fitted values (e.g. U-shape,..) = violation of the log-linearity assumption.
...
uniSorted <- sort(glms.lvm.sand.summary$uni.test[2, ], decreasing = TRUE, index.return = TRUE)
