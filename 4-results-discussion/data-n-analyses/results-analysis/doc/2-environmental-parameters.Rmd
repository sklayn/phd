...
Unfortunately, I'll transcribe them by hand in the appendix (no time to figure out better ways), which means endless hassle if anything at all changes at some point..   
...
write_csv(water.params.summary.st.LT %>% select(station, contains("mean")), 
...
```
Savve this, too (again, means per m2 only). 
