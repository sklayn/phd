...
write_rds(comm.diff.2012.mod, file.path(save.dir, "comm_diff_model_2012.RDS"))

write_rds(comm.diff.2012.mod.summary, file.path(save.dir, "comm_diff_model_2012_summary.RDS"))

## community difference between stations & habitats within each site
write_rds(comm.diff.2012.st, file.path(save.dir, "comm_diff_st_model_2012.RDS"))

write_rds(comm.diff.2012.st.summary, file.path(save.dir, "comm_diff_st_model_2012_summary.RDS"))
```
