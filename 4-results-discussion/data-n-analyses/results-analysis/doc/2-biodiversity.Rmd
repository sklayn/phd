...
plot(sac.zostera, 
     ...
     ci.type = "polygon", ci.col = "light blue")
```
  Again, about 10 (mayeb a little more) samples seem to be enough to capture most of the biodiversity in the study area (in terms of species richness) - this is where the curve starts to smooth out (slope < 1). In my seagrass dataset, there are 8 samples/station for most (except Ropotamo & Vromos - 4 each, only one sampling) - marginally enough, but should be kept in mind, esp. for those two under-sampled stations.  
  NB IF this method is applied correctly, since the samples are not independent but in fact represent replicates at each station..   
...
#### Macrozoobenthic communities in Sozopol Bay (2012)  
